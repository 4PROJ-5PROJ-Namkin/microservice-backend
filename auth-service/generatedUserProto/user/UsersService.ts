...
export interface UsersServiceClient extends grpc.Client {
  ...
  getAllUsers(argument: _user_Empty, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, metadata: grpc.Metadata, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, options: grpc.CallOptions, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, metadata: grpc.Metadata, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, options: grpc.CallOptions, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
  getAllUsers(argument: _user_Empty, callback: grpc.requestCallback<_user_Users__Output>): grpc.ClientUnaryCall;
...
export interface UsersServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  getAllUsers: grpc.handleUnaryCall<_user_Empty__Output, _user_Users>;
...
export interface UsersServiceDefinition extends grpc.ServiceDefinition {
  ...
  getAllUsers: MethodDefinition<_user_Empty, _user_Users, _user_Empty__Output, _user_Users__Output>
