...
import type { HelloResponse as _auth_HelloResponse, HelloResponse__Output as _auth_HelloResponse__Output } from '../auth/HelloResponse';
...
export interface AuthServiceClient extends grpc.Client {
  ...
  getHelloAuth(argument: _auth_Empty, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, metadata: grpc.Metadata, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, options: grpc.CallOptions, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, metadata: grpc.Metadata, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, options: grpc.CallOptions, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
  getHelloAuth(argument: _auth_Empty, callback: grpc.requestCallback<_auth_HelloResponse__Output>): grpc.ClientUnaryCall;
...
export interface AuthServiceHandlers extends grpc.UntypedServiceImplementation {
  ...
  getHelloAuth: grpc.handleUnaryCall<_auth_Empty__Output, _auth_HelloResponse>;
...
export interface AuthServiceDefinition extends grpc.ServiceDefinition {
  ...
  getHelloAuth: MethodDefinition<_auth_Empty, _auth_HelloResponse, _auth_Empty__Output, _auth_HelloResponse__Output>
