...
async function bootstrap() {
  ...
  const openApiOptions = new DocumentBuilder()
    ...
    .setDescription('<a href="/api/v1/production/production-swagger-spec.json" target="_blank">http://localhost:3000/api/v1/production/production-swagger-spec.json</a>')
    .setVersion('v1')
    .addServer('/api/v1')
    .build();
